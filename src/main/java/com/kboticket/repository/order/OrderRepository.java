...
public interface OrderRepository extends JpaRepository<Order, String>, OrderCustomRepository {
    ...
    @Query("SELECT new com.kboticket.dto.order.OrderDetailDto(t.orderSeat.seat.level, t.orderSeat.seat.block, t.orderSeat.seat.number, t.price," +
            " t.ticketNumber, t.cancelAvailableAt, t.isCanceled," +
           ...
           "WHERE o.id = :orderId")
    Optional<OrderDetailDto> findOrderDetailById(@Param("orderId") String orderId);
}
